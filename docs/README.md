...
アプリの実務的な使い方とワークフローをまとめたユーザー向けマニュアル。

**対象読者**: エンジニア、部品管理担当、QA 担当

**内容**:
- アプリの起動から差分比較・エクスポートまでの操作手順
- 辞書機能や前処理ブロックの活用方法
- トラブルシューティングと FAQ
- ログや設定ファイルの場所
...
### [../README.md](../README.md)
プロジェクトの概要とセットアップを説明するメインドキュメント。
...
### README.md を更新するとき
- 新機能を追加したとき（概要を追記、詳細は USER_GUIDE.md へ）
- セットアップ手順が変更されたとき
- ドキュメントのリンク構成が変わったとき
...
- **SCREENSHOTS.md** - UI スクリーンショット集 (USER_GUIDE.md と連携予定)
