...
### フェーズ1: 低リスク修正（30分）✅
- [x] 1-1. console.logの環境変数化
- [x] 1-2. イベントリスナーのメモリリーク修正（App.tsx）
- [x] 1-3. cloneRows関数の統合と共通化
- [x] 1-4. TypeScriptコンパイル確認
- [x] 1-5. ビルド確認

### フェーズ2: 中リスク修正（2-3時間）✅
- [x] 2-1. React.memoをEditableTableに追加
- [x] 2-2. テーブル仮想化ライブラリ導入（react-window）→500行制限に簡略化
- [x] 2-3. EditableTableを仮想化に対応→500行制限に簡略化
- [x] 2-4. useMemoの依存配列最適化
- [x] 2-5. インラインイベントハンドラの最適化→スキップ
- [x] 2-6. Rust参照展開の最適化（reference.rs）
- [x] 2-7. TypeScriptコンパイル確認
- [x] 2-8. Rustコンパイル確認
- [x] 2-9. ビルド確認
